<template>
  <div class="di relative">
    <span v-if="employee.address" class="mt0 mb0" data-cy="employee-location">
      ...
      <Link v-if="permissions.can_see_complete_address" :href="employee.url.edit_address" class="di f7 ml2">
        {{ $t('app.edit') }}
      </Link>
    </span>

    <!-- case of no address set in profile -->
    <Link v-if="!employee.address && permissions.can_edit_profile" :href="employee.url.edit_address" class="di f7">
